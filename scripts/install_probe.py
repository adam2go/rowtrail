...
with tempfile.TemporaryDirectory(prefix='rowtrail-install-test-') as directory:
    ...
    analysis=json.loads(subprocess.check_output(['python3',str(package/'examples/analysis_quickstart.py'),'--rowtrail',str(binary),'--directory',str(base/'analysis')],text=True))
