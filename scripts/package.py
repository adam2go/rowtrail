...
with tarfile.open(archive, "w:xz", preset=6) as output:
    ...
    for item in ("README.md", "README.zh-CN.md", "LICENSE", "NOTICE", "third-party", "docs/progress.md",
                 "docs/agent-guide.md", "docs/agent-quickstart.md", "docs/usage.md", "docs/numeric-contract.md",
                 "examples/session_client.py", "examples/quickstart.py", "examples/analysis_quickstart.py", "docs/analysis.md", "examples/agent_demo.py", "docs/agent-demo.md"):
